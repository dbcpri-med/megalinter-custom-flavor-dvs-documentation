# MegaLinter Custom Flavor: DVS Documentation

This custom MegaLinter aims to have an optimized Docker image size.

It is built from official MegaLinter images, but is maintained on https://github.com/dbcpri-med/megalinter-custom-flavor-dvs-documentation by Amanda Kitson
...
- GitHub Action: On MegaLinter step in .github/workflows/mega-linter.yml, define `uses: dbcpri-med/megalinter-custom-flavor-dvs-documentation@main`
- Docker image: Replace official MegaLinter image with `ghcr.io/dbcpri-med/megalinter-custom-flavor-dvs-documentation/megalinter-custom-flavor:latest`
